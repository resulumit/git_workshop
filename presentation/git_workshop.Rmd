...
- it is  a folder, which can keep files and other folders containing files
...
&nbsp;&nbsp;  │ &nbsp;&nbsp; &nbsp;&nbsp; &nbsp;&nbsp; ├── info     
&nbsp;&nbsp;  │ &nbsp;&nbsp; &nbsp;&nbsp; &nbsp;&nbsp; └── .yellow-h[0e]    
&nbsp;&nbsp;  │ &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; &nbsp;&nbsp; &nbsp;&nbsp; └── .yellow-h[42fba1f48dd5cbffc4bc769928c4f7afa40852]     
&nbsp;&nbsp; │     
&nbsp;&nbsp; ├── .yellow-h[index]     
&nbsp;&nbsp; ... 
...
- Use the `git` `add ` command (and then, the `git` `commit` command)
    - not only to add a new file to versions
    - but also, once that file changes, to create a new version every time
...
Recall that
- committing requires files in the staging area
...
- add a new sentence and/or delete an old one
...
9) Repeat the exercises above one more time
